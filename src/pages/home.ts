...
export const template: string = `
    <section class="hero-split">
        <div class="hero-text-side">
            ...
            <div class="hero-bio">
                <p data-text-en="Think of me as a Swiss Army knife — I dive deep into any technology or domain, eager to learn new things daily. Whether it's building AI-driven systems, developing medical sensor systems, or solving complex technical challenges." data-text-de="Stell dir mich als Schweizer Taschenmesser vor — ich tauche tief in jede Technologie oder Domäne ein, täglich eifrig darauf, neue Dinge zu lernen. Ob es darum geht, KI-gestützte Systeme zu entwickeln, medizinische Sensorsysteme zu entwickeln oder komplexe technische Herausforderungen zu lösen.">
