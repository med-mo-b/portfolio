        ...
        <div class="hero-text-side">
            ...
            <div class="hero-bio">
                ...
                <p class="bio-desktop" 
                   ...
                   data-text-de="Stell dir mich als Schweizer Taschenmesser vor — ich tauche tief in jede Technologie oder Domäne ein, täglich eifrig darauf, neue Dinge zu lernen. Ob es darum geht, KI-gestützte Systeme zu entwickeln, medizinische Sensorsysteme zu entwickeln oder komplexe technische Herausforderungen zu lösen.">
